...
import io.casperlabs.casper.genesis.DeployPaymentCostTest._
import io.casperlabs.casper.genesis.contracts.{Faucet, PreWallet}
import io.casperlabs.casper.helper.HashSetCasperTestNode
import io.casperlabs.casper.protocol.{BlockMessage, Deploy, DeployData}
import io.casperlabs.casper.util.ProtoUtil
import io.casperlabs.casper.util.rholang.RuntimeManager
import io.casperlabs.casper.{genesis => _, _}
import io.casperlabs.crypto.codec.Base16
import io.casperlabs.crypto.hash.{Blake2b256, Keccak256}
import io.casperlabs.crypto.signatures.{Ed25519, Secp256k1}
import io.casperlabs.models.Expr.ExprInstance._
import io.casperlabs.models.Var.VarInstance.{BoundVar, FreeVar}
import io.casperlabs.models._
import io.casperlabs.models.rholang.implicits._
import io.casperlabs.rholang.interpreter.{accounting, InterpolateRholang}
import io.casperlabs.rspace.Serialize
...
object DeployPaymentCostTest {
  ...
  def bytes(par: Par): Array[Byte] = {
    import io.casperlabs.models.serialization.implicits._
