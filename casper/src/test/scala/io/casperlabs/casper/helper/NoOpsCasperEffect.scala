...
class NoOpsCasperEffect[F[_]: Sync: BlockStore: DagStorage] private (
...
object NoOpsCasperEffect {
  def apply[F[_]: Sync: BlockStore: DagStorage](
  ...
  def apply[F[_]: Sync: BlockStore: DagStorage](): F[NoOpsCasperEffect[F]] =
    apply(
