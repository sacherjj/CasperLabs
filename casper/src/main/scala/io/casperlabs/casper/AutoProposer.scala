...
class AutoProposer[F[_]: Concurrent: Time: Log: Metrics: MultiParentCasperRef: DeployStorage: Broadcaster: EventEmitterContainer](
...
object AutoProposer {
  ...
  def apply[F[_]: Concurrent: Time: Log: Metrics: MultiParentCasperRef: DeployStorage: Broadcaster: EventEmitterContainer](
      checkInterval: FiniteDuration,
      ballotInterval: FiniteDuration,
      accInterval: FiniteDuration,
      accCount: Int,
