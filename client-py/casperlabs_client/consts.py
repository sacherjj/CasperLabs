...
SECP256K1_ETHEREUM_KEY_ALGORITHM = "secp256k1"
# To be used in ECO-463 with `faste SECR256K1_SECURE_ENCLAVE_KEY_ALGORITHM = "secr256k1"
SUPPORTED_KEY_ALGORITHMS = (ED25519_KEY_ALGORITHM, SECP256K1_ETHEREUM_KEY_ALGORITHM)
...
ACCOUNT_HASH_FILENAME_SUFFIX: str = "-hash"
