...
package object gossiping {
  ...
  val BlockGossipingMetricsSource  = Metrics.Source(GossipingMetricsSource, "blocks")
  val DeployGossipingMetricsSource = Metrics.Source(GossipingMetricsSource, "deploys")
