...
describe('sign', () => {
  it('should compute the same signature as Scala', () => {
    ...
    const inputBase16 = "20bb4422795c2c61285b230a5b185339caa6c1d143092b5041cd0f96e8bf062c";
    const input = Buffer.from(inputBase16, 'hex');
    const publicKeyBase64 = "MCowBQYDK2VwAyEALnsOUzZT5+6UvOo2fEXyOr993f+Zjj1aFe2BBeR78Dc=";
    const privateKeyBase64 = "MC4CAQAwBQYDK2VwBCIEIEIcqHCVzuejJfD9wCoGVOLc3YFNUa9dcsy+mv5j2sar";
    ...
    const expectedHex = "1babb50ad05f179985295654e2f1b31ef0b15637efbca7cc8b6601158e67811bc1aa0e4ee30271a6e68ec658495f2f2360b67bea733baec97e63b960efe9b00c";
