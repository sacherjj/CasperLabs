...
def test_blocks_infect_network_R1(not_all_connected_directly_nodes):
    """
...
def test_network_partition_and_rejoin_R0(four_nodes_network):
    """
    Feature file: block_gossiping.feature
