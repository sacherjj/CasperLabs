...
# source: protos/scalapb/scalapb.proto
...
ScalaPbOptions = _reflection.GeneratedProtocolMessageType('ScalaPbOptions', (_message.Message,), dict(
  ...
  __module__ = 'protos.scalapb.scalapb_pb2'
