...
object Configuration extends ParserImplicits {
  ...
  case class Server(
      ...
      dataDir: Path,
      maxNumOfConnections: Int Refined NonNegative,
      maxMessageSize: Int Refined Positive,
      eventStreamBufferSize: Int Refined Positive,
      engineParallelism: Int Refined Positive,
      chunkSize: Int Refined Positive,
      relayFactor: Int Refined NonNegative,
      relaySaturation: Int Refined NonNegative,
      approvalRelayFactor: Int Refined NonNegative,
      ...
      downloadMaxParallelBlocks: Int Refined Positive,
