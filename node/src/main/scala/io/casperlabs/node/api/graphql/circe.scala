...
/**
  * Circe (un)marshallers, borrowed from https://github.com/sangria-graphql/sangria-circe
  * Copy-pasted because of runtime binary incompatibilities between dependencies.
  */
private[graphql] object circe {
  implicit object CirceResultMarshaller extends ResultMarshaller {
    ...
    def scalarNode(value: Any, typeName: String, info: Set[ScalarValueInfo]) = value match {
      ...
      case v: Float      ⇒ Json.fromDoubleOrNull(v.toDouble)
