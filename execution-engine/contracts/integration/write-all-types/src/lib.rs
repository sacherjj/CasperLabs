...
pub extern "C" fn call() {
    ...
    let v13: URef = storage::new_turef(()).into();
    ...
    let u001 = storage::new_turef(v01);
    let u002 = storage::new_turef(v02);
    let u003 = storage::new_turef(v03);
    let u004 = storage::new_turef(v04);
    let u005 = storage::new_turef(v05);
    let u006 = storage::new_turef(v06);
    let u007 = storage::new_turef(v07);
    let u008 = storage::new_turef(v08);
    let u009 = storage::new_turef(v09);
    let u010 = storage::new_turef(v10);
    let u011 = storage::new_turef(v11);
    let u012 = storage::new_turef(v12);
    let u013 = storage::new_turef(v13);
    let u014 = storage::new_turef(v14);
    let u015 = storage::new_turef(v15);
    let u016 = storage::new_turef(v16);
    let u017 = storage::new_turef(v17);
    let u018 = storage::new_turef(v18);
    let u019 = storage::new_turef(v19);
    let u020 = storage::new_turef(v20);
    let u021 = storage::new_turef(v21);
