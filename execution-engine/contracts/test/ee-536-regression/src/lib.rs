...
pub extern "C" fn call() {
    ...
    contract_api::account::add_associated_key(key_1, Weight::new(10))
        .unwrap_or_else(|_| contract_api::runtime::revert(Error::User(100)));
    contract_api::account::add_associated_key(key_2, Weight::new(11))
        .unwrap_or_else(|_| contract_api::runtime::revert(Error::User(101)));

    contract_api::account::set_action_threshold(ActionType::KeyManagement, Weight::new(13))
        .unwrap_or_else(|_| contract_api::runtime::revert(Error::User(200)));
    contract_api::account::set_action_threshold(ActionType::Deployment, Weight::new(10))
        .unwrap_or_else(|_| contract_api::runtime::revert(Error::User(201)));

    match contract_api::account::remove_associated_key(key_2) {
        ...
        Err(_) => contract_api::runtime::revert(Error::User(300)),
        Ok(_) => contract_api::runtime::revert(Error::User(301)),
    }

    match contract_api::account::set_action_threshold(ActionType::KeyManagement, Weight::new(255)) {
        ...
        Err(_) => contract_api::runtime::revert(Error::User(400)),
        Ok(_) => contract_api::runtime::revert(Error::User(401)),
    }
    // Key management threshold is 11, so changing threshold of key from 10 to 11
    // would violate
    match contract_api::account::update_associated_key(key_2, Weight::new(1)) {
        ...
        Err(_) => contract_api::runtime::revert(Error::User(500)),
        Ok(_) => contract_api::runtime::revert(Error::User(501)),
    }
}
