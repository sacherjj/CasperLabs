...
pub extern "C" fn check_caller_ext() {
    let caller_public_key: PublicKey = contract_api::runtime::get_caller();
    contract_api::runtime::ret(&caller_public_key, &Vec::new())
}

#[no_mangle]
pub extern "C" fn call() {
    let known_public_key: PublicKey = contract_api::runtime::get_arg(0)
    ...
    let pointer =
        contract_api::storage::store_function_at_hash("check_caller_ext", BTreeMap::new());
