...
/// Stores the serialized bytes of an exported `extern "C"` function as a new contract under a
/// [`URef`] generated by the host.
...
/// Stores the serialized bytes of an exported `extern "C"` function as a new contract at an
