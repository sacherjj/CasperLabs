...
const DO_NOTHING_FN: [u8; 32] = [
    67, 199, 39, 112, 64, 242, 105, 254, 209, 5, 0, 85, 218, 155, 248, 45, 212, 192, 105, 176, 205,
    117, 123, 114, 204, 233, 173, 136, 98, 236, 4, 164,
];

const DO_SOMETHING_FN: [u8; 32] = [
    181, 17, 58, 89, 64, 111, 110, 96, 183, 14, 31, 165, 120, 145, 22, 58, 105, 214, 212, 173, 87,
    17, 118, 228, 117, 206, 29, 137, 203, 240, 4, 143,
];
