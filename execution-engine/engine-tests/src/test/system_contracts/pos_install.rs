...
fn should_run_pos_install_contract() {
    ...
    // let bonding_purse =
    //     get_purse(named_keys, POS_BONDING_PURSE).expect("should find bonding purse in
    // named_keys");
    //
    ...
    // let payment_purse =
    //     get_purse(named_keys, POS_PAYMENT_PURSE).expect("should find payment purse in
    // named_keys");
    //
    ...
    // let rewards_purse =
    //     get_purse(named_keys, POS_REWARDS_PURSE).expect("should find rewards purse in
    // named_keys");
    //
