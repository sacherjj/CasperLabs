    ...
    R::Error: Into<Error>,
{
    ...
    pub fn call_versioned_contract(
        &mut self,
        _contract_metadata_hash: ContractPackageHash,
        ...
        //                 {
        //                     // Session code can't be called from Contract code for security
        // reasons.                     return Err(Error::InvalidContext);
        //                 }
        //                 EntryPointType::Session => {
