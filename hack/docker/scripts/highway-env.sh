...
CL_CHAINSPEC_HIGHWAY_ERA_DURATION=${CL_CHAINSPEC_HIGHWAY_ERA_DURATION:-"10minutes"}
CL_CHAINSPEC_HIGHWAY_BOOKING_DURATION=${CL_CHAINSPEC_HIGHWAY_BOOKING_DURATION:-"16minutes"}
CL_CHAINSPEC_HIGHWAY_ENTROPY_DURATION=${CL_CHAINSPEC_HIGHWAY_ENTROPY_DURATION:-"2minute"}
CL_CHAINSPEC_HIGHWAY_VOTING_PERIOD_DURATION=${CL_CHAINSPEC_HIGHWAY_VOTING_PERIOD_DURATION:-"2minute"}
